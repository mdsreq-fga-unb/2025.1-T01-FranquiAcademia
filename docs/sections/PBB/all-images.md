# Product Vision & Product Backlog - FranquiAcademia

Este documento descreve a visão do produto, as personas envolvidas, as funcionalidades e os itens do backlog para o projeto FranquiAcademia.
